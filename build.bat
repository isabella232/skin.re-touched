...
START /B /WAIT ..\..\Tools\Depends\Native\TexturePacker\TexturePacker -dupecheck -input media -output ..\..\project\Win32BuildSetup\BUILD_WIN32\addons\skin.re-touched\media\Textures.xbt
